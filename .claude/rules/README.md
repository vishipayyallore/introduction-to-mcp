# `.claude/rules/` — Claude Code rule supplements

These Markdown files extend the repository’s baseline instructions for **Claude Code** and other
Claude-oriented tooling. They do **not** replace root **`AGENTS.md`**, root **`CLAUDE.md`**, or
**`.cursor/rules/`**; read those together.
